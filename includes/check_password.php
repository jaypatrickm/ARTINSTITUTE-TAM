...
//this is an example of object-oriented coding, which we haven't covered in Advanced Web-Based
//Programming.  But you can still get tbe jist of what the code does, even if all the
//syntax isn't totally familiar.
