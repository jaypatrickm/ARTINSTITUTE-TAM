...
$(document).ready(function(){
	$('.answer').hide();
 	$('#fixedwing_accordion h3').toggle(
		function() {
	   $('.answer').hide();
	   $('#fixedwing_accordion h3').removeClass('close');
...
<title>Tomorrow's Aeronautical Museum - Fixed Wing Flight School</title>
</head>
...
<div id="container">
    ...
    <div id="title" class="fixedwing_header_shift">
    	<img src="images/header_fixedwing.png" alt="TAM" />
    </div>
    
	<div id="fixedwing_content">
 		<div id="fixedwing_top">
        	<h1>Become a pilot</h1>
            <p>We have brought together all of the proper elements to provide you with the most thrilling, rewarding, and complete aviation experience possible. We think the combination of seasoned professional instructors, clean, well maintained equipment, a wide variety of standard & exotic aircraft, state of the are facilities, and a staff that is focused on the same goal of providing excellent customer service is the right one for unparalleled satisfaction.The Aero Squad is based at Compton Woodley Airport, 961 West Alondra Blvd., Compton, CA, 90220. Click here for directions This school is a branch of Tomorrow’s Aeronautical Museum, a 501(c)3 non-profit educational institute that integrates youth mentorin with aviation, community involvement, outreach and social action. The museum is a dynamic integral part of the community serving the children, young adults and their families.</p><br />
...
<p>We have a comprehensive training program that is flexible enough to train you for any license you are seeking. Weather it is to simply make the joy of flying an everyday occurrence, strictly for pleasure as a private pilot, or to secure a rewarding career as a professional pilot flying airliners all around the world. </p>
           		...
           		<h3>Financing available</h3>
          			<div class="answer">
            			<p>We can finance your entire training program, even living expenses. Our professional pilot program will get you financed, trained, and employed, all before you have to make any payments. Give us a call (310) 618-1155 <a href="pilotcareer.org" alt="financing">Click here for Financing.</a></p>
